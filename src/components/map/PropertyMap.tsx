  ...
  return (
    <div className="mx-auto max-w-[1600px] px-4 py-6 sm:px-6">
      ...
      <div className="grid gap-4 lg:grid-cols-[380px_1fr]">
        ...
        {/* تم تعطيل الخريطة مؤقتاً للاختبار */}
        <div className="relative h-[78vh] flex items-center justify-center overflow-hidden rounded-xl border border-border bg-surface">
          <p className="text-muted-foreground">تم إيقاف الخريطة مؤقتاً للفحص — هل اختفى التعليق؟</p>
        </div>
      </div>
    </div>
  );
